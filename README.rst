...
the ``pygranta`` metapackage is downloading the wheelhouse archive for your corresponding machine
architecture from the repository's `Releases <https://github.com/ansys/pygranta/releases>`_ page.
...
a fresh Python installation or in a virtual environment.
...
Ansys product release mechanism. Thus, this versioning system is followed:
